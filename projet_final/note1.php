...
if ($mysqli->connect_error) {
...
else { $images_repas ="<form method='post' action='traite_note1.php'>";
	...
	$requete = "SELECT `id_movie`,`title`,`director`,`genre1`,`genre2`,`genre3`,`actor1`, `actor2`,`actor3`,`IMDB_Link`,`cluster` FROM Movies WHERE id in ($_SESSION[film1]) ORDER BY id_movie;";
        ...
        $resultat = $mysqli->store_result();
         ...
         $_SESSION['m1'][1] = $ligne['id_movie'];
         $_SESSION['cluster1'] = $ligne['cluster'];
...
$requete = "SELECT `id_movie`,`title`,`director`,`genre1`,`genre2`,`genre3`,`actor1`, `actor2`,`actor3`,`IMDB_Link`,`cluster` FROM Movies WHERE id in ($_SESSION[film2]) ORDER BY id_movie;";
        $requete .= "SELECT `Physical_text`FROM Context_Physical WHERE id_context1 in ($_SESSION[context_physical2]);";
        $requete .= "SELECT `Mood_text` FROM Context_Mood WHERE id_context2 in ($_SESSION[context_mood2]);";
        $requete .= "SELECT Location_text FROM Context_Location WHERE id_context3 in ($_SESSION[context_location2]);";
        $requete .= "SELECT Companion_text FROM Context_Companion WHERE id_context4 in ($_SESSION[context_companion2])";
        if ($mysqli->multi_query($requete)){
        $resultat = $mysqli->store_result();
             if ($mysqli->next_result()){
             $contextphy = $mysqli->store_result();
         ...
         $ligne = $resultat->fetch_assoc();
         $_SESSION['m1'][2] = $ligne['id_movie'];
         $_SESSION['cluster2'] = $ligne['cluster'];
         $context1 = $contextphy->fetch_assoc();
         $context2 = $contextmood->fetch_assoc();
         $context3 = $contextloca->fetch_assoc();
         $context4 = $contextcomp->fetch_assoc();
...
$requete = "SELECT `id_movie`,`title`,`director`,`genre1`,`genre2`,`genre3`,`actor1`, `actor2`,`actor3`,`IMDB_Link`,`cluster` FROM Movies WHERE id in ($_SESSION[film3]) ORDER BY id_movie;";
        $requete .= "SELECT `Physical_text`FROM Context_Physical WHERE id_context1 in ($_SESSION[context_physical3]);";
        $requete .= "SELECT `Mood_text` FROM Context_Mood WHERE id_context2 in ($_SESSION[context_mood3]);";
        $requete .= "SELECT Location_text FROM Context_Location WHERE id_context3 in ($_SESSION[context_location3]);";
        $requete .= "SELECT Companion_text FROM Context_Companion WHERE id_context4 in ($_SESSION[context_companion3])";
        if ($mysqli->multi_query($requete)){
        $resultat = $mysqli->store_result();
             if ($mysqli->next_result()){
             $contextphy = $mysqli->store_result();
         ...
         $ligne = $resultat->fetch_assoc();
         $_SESSION['m1'][3] = $ligne['id_movie'];
         $_SESSION['cluster3'] = $ligne['cluster'];
         $context1 = $contextphy->fetch_assoc();
         $context2 = $contextmood->fetch_assoc();
         $context3 = $contextloca->fetch_assoc();
         $context4 = $contextcomp->fetch_assoc();
