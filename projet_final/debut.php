...
<div class="div-body">   
    <body>
		...
		<h1 align="center" style="position: relative;top: -40px;"> Questionnaire sur les explications dans les systèmes de recommandation  </h1>

	
        <h2 align="center"> Bonjour !</h2><br />
        
        <h3 align="center"> 
            Nous sommes chercheurs dans laboratoire LAMSADE (Laboratoire d'analyse et modélisation de systèmes pour l'aide à la décision) -- Université Paris Dauphine. Nous menons une étude sur les explications dans les systèmes de recommandation. A fin de nous aider à dans cette recherche, nous vous remercions de remplir ce questionnaire qui reporte sur le cinéma. <br /><br />
            Vos avis sont précieux et doivent reflectent aux mieux vos préférences à propos des films que nous allons vous proposer.
        </h3>
