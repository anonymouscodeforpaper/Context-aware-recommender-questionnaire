...
if ($mysqli->connect_error) {
	...
	$images_repas ="<form method='post' action='traite_effectiveness.php'>";
...
<body> 
        <h1>Etape 4/4: </h1>
	<h2>Veuillez indiquer dans quelle mesure les explications vous aident à prendre une meilleure décision(à mieux estimer une note que vous allez donner) de 1(pas du tout) à 5(beaucoup)</h2>
	<br />
