...
if ($mysqli->connect_error) {
	...
	$images_repas ="<form method='post' action='traite_persuasiveness.php'>";
...
<body> 
        <h1>Etape 4/4: </h1>
	<h2>Veuillez indiquer dans quelle mesure vous pensez que les explications sont persuasives de 1(pas du tout) à 5(beaucoup)</h2>
	<br />
