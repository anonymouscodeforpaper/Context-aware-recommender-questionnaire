...
if ($mysqli->connect_error) {
	...
	$requete = "SELECT `id_movie`,`title`,`director`,`genre1`,`genre2`,`genre3`,`actor1`, `actor2`,`actor3`,`IMDB_Link` FROM Movies WHERE id_movie = $_SESSION[recommendation1] ORDER BY id_movie";
	$resultat = $mysqli->query($requete); 
	$images_repas ="<form method='post' action='traite_noexp1.php'>";
...
<body>
	...
	<h2>Veuillez noter ce film selon l'explication founie ci-dessous de 1(je n'aime pas du tout) à 5(j'aime beaucoup): </h2>
        <h3>Voici les informtaions détaillées de la 1er recommandation. </h3>
	<br />
